...
import org.jetbrains.research.intellijdeodorant.core.distance.DirectedGraph;
...
public class FeatureEnvyTest extends LightJavaCodeInsightFixtureTestCase {
    ...
    private double getEntityPlacementOfSystem(String fromClass, String toClass) {
        myFixture.addFileToProject("src/resources/A.java", fromClass);
        myFixture.addFileToProject("src/resources/B.java", toClass);
        myFixture.allowTreeAccessForAllFiles();
        Project project = myFixture.getProject();
        ...
        return directedGraph.caculateEntityPlacementOfSystem();
    }
    ...
    public void testCaculateEntityPlacementOfSystem() {
        String fromClass = "package testCases.featureEnvy;\n" +
                "import testCases.featureEnvy.B;\n" +
                "\n" +
                "public class A {\n" +
        ...
        String toClass = "package testCases.featureEnvy;\n" +
                ...
                "  }\n" +
                "}";
        double ans = getEntityPlacementOfSystem(fromClass, toClass);
