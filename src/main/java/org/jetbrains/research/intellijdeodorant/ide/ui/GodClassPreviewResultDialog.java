    ...
    private class MyCacheDiffRequestChainProcessor extends CacheDiffRequestChainProcessor {
        ...
        private void updateDiff() {
            ...
            if (selectedPath != null) {
                ...
                if (lastComponent == previewProcessor.getExtractedClass()) {
                ...
                } else if (lastComponent instanceof ExtractClassPreviewProcessor.PsiClassWrapper) {
                ...
                } else if (lastComponent instanceof ExtractClassPreviewProcessor.PsiElementChange) {
                    ExtractClassPreviewProcessor.PsiElementChange elementChange = (ExtractClassPreviewProcessor.PsiElementChange) lastComponent;
                    ...
                    switch (elementChange.getChangeType()) {
                        ...
                        case ADD_AFTER: {
                            ...
                            if (elementChange.getChangeType() == ExtractClassPreviewProcessor.PsiElementChange.ChangeType.ADD_BEFORE) {
                                anchor.getParent().addBefore(elementToAdd, anchor);
                            } else if (elementChange.getChangeType() == ExtractClassPreviewProcessor.PsiElementChange.ChangeType.ADD_AFTER) {
                ...
                } else if (lastComponent instanceof ExtractClassPreviewProcessor.PsiMethodComparingPair) {
                    ExtractClassPreviewProcessor.PsiMethodComparingPair methodPair = (ExtractClassPreviewProcessor.PsiMethodComparingPair) lastComponent;
                ...
                } else if (lastComponent instanceof ExtractClassPreviewProcessor.PsiElementComparingPair) {
                    ExtractClassPreviewProcessor.PsiElementComparingPair elementPair = (ExtractClassPreviewProcessor.PsiElementComparingPair) lastComponent;
        ...
        private class TreeTableList extends DefaultTreeModel implements TreeTableModel {
            ...
            public Object getValueAt(Object node, int column) {
                if (node instanceof ExtractClassPreviewProcessor.PsiMethodComparingPair) {
                    return ((ExtractClassPreviewProcessor.PsiMethodComparingPair) node).getInitialPsiMethod().getName();
                } else if (node instanceof ExtractClassPreviewProcessor.PsiElementComparingPair) {
                    return ((ExtractClassPreviewProcessor.PsiElementComparingPair) node).getInitialPsiElement().getText();
                }
            ...
            public boolean isLeaf(Object node) {
                if (node instanceof ExtractClassPreviewProcessor.PsiMethodComparingPair && getChildCount(node) == 0) {
                    return true;
                }

                return node instanceof ExtractClassPreviewProcessor.PsiElementComparingPair ||
                        node instanceof ExtractClassPreviewProcessor.PsiElementChange ||
                        node == previewProcessor.getExtractedClass();
            }

            @Override
            public Object getChild(Object parent, int index) {
                if (parent instanceof ExtractClassPreviewProcessor.PsiMethodComparingPair) {
                    PsiMethod initialMethod = ((ExtractClassPreviewProcessor.PsiMethodComparingPair) parent).getInitialPsiMethod();
                    List<ExtractClassPreviewProcessor.PsiElementComparingPair> children = previewProcessor.getMethodElementsComparingMap().get(initialMethod);
                    if (children != null) {
                        return children.get(index);
                    }
                } else if (parent instanceof ExtractClassPreviewProcessor.PsiClassWrapper) {
            ...
            public int getChildCount(Object parent) {
                ...
                } else if (parent instanceof ExtractClassPreviewProcessor.PsiElementComparingPair) {
                    return 0;
                ...
                } else if (parent instanceof ExtractClassPreviewProcessor.PsiElementChange) {
                    return 0;
                }
