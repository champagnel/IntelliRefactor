...
public abstract class AbstractRefactoringPanel extends JPanel {
    ...
    private void highlightCode(InputEvent e) {
        ...
        if (selectedPath != null) {
            Object o = selectedPath.getLastPathComponent();
            if (refactoringType.instanceOfCandidateRefactoring(o)) {
                RefactoringType.AbstractCandidateRefactoring refactoring = (RefactoringType.AbstractCandidateRefactoring) o;
    ...
    public RefactoringType.AbstractRefactoring getAbstractRefactoringFromAbstractCandidateRefactoring(RefactoringType.AbstractCandidateRefactoring candidate) {
