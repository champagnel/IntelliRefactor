...
public abstract class AbstractTreeTableModel extends DefaultTreeModel implements TreeTableModel {
    ...
    public AbstractTreeTableModel(List<RefactoringType.AbstractCandidateRefactoringGroup> candidateRefactoringGroups,
    ...
    public void setCandidateRefactoringGroups(List<RefactoringType.AbstractCandidateRefactoringGroup> candidateRefactoringGroups) {
        this.candidateRefactoringGroups = candidateRefactoringGroups;
    }

    public List<RefactoringType.AbstractCandidateRefactoringGroup> getCandidateRefactoringGroups() {
