...
public class GodClassUserInputDialog extends RefactoringDialog {
    ...
    private ExtractClassRefactoringType.AbstractExtractClassRefactoring abstractRefactoring;
    @Nullable
    ...
    public GodClassUserInputDialog(ExtractClassRefactoringType.AbstractExtractClassRefactoring abstractRefactoring, AbstractRefactoringPanel godClassPanel) {
